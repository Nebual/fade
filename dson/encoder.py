...
def encode_basestring(s):
    """Return a DSON representation of a Python string
...
class DSONEncoder(object):
    """Extensible DSON <http://json.org> encoder for Python data structures.
    ...
    def __init__(self, skipkeys=False, ensure_ascii=True,
        ...
        encoded as such.  This behavior is not DSON specification compliant,
        but is consistent with most JavaScript based encoders and decoders.
        Otherwise, it will be a ValueError to encode such floats.

        If sort_keys is true, then the output of dictionaries will be
        sorted by key; this is useful for regression tests to ensure
        that DSON serializations can be compared on a day-to-day basis.

        If indent is a non-negative integer, then DSON array
        ...
        transformed into unicode using that encoding prior to DSON-encoding.
    ...
    def default(self, o):
        ...
        implement default like this::
            ...
            def default(self, o):
                ...
                return DSONEncoder.default(self, o)
    ...
    def iterencode(self, o, _one_shot=False):
        ...
        For example::
            ...
            for chunk in DSONEncoder().iterencode(bigobject):
        ...
        def floatstr(o, allow_nan=self.allow_nan,
            ...
            if not allow_nan:
                raise ValueError(
                    "Out of range float values are not DSON compliant: " +
                    repr(o))
